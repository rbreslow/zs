...
if CLIENT then
    ...
    function SWEP:DrawWorldModel()
        ...
        if not IsValid(owner) then
            ...
            self:AddWM(owner,"models/props_interiors/pot02a.mdl",Vector(-0.5,-6,5),Angle(15,180,-90),false,Vector(1,1,1),"")
        end
    end
    ...
    function SWEP:PostDrawViewModel(vm,ply,wep)
        ...
        self:AddVM(vm,"models/props_interiors/pot02a.mdl",Vector(0,-8,2.5),Angle(0,180,-90),"ValveBiped.Bip01_R_Hand",Vector(1,1,1),"")
    end
end
