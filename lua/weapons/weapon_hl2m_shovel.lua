...
if CLIENT then
    ...
    function SWEP:DrawWorldModel()
        ...
        if not IsValid(owner) then
            ...
            self:AddWM(owner,"models/props_junk/Shovel01a.mdl",Vector(2,-6,5),Angle(15,90,0),false,Vector(0.75,0.75,0.75),"")
        end
    end
    ...
    function SWEP:PostDrawViewModel(vm,ply,wep)
        ...
        self:AddVM(vm,"models/props_junk/Shovel01a.mdl",Vector(1.4,-6,4),Angle(0,180,0),"ValveBiped.Bip01_R_Hand",Vector(0.75,0.75,0.75),"")
    end
end
