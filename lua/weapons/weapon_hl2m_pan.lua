...
if CLIENT then
    ...
    function SWEP:DrawWorldModel()
        ...
        if not IsValid(owner) then
            ...
            self:AddWM(owner,"models/props_c17/metalPot002a.mdl",Vector(-1,-10,6),Angle(105,180,-90),false,Vector(1,1,1),"")
        end
    end
    ...
    function SWEP:PostDrawViewModel(vm,ply,wep)
        ...
        self:AddVM(vm,"models/props_c17/metalPot002a.mdl",Vector(0.5,-10,2.5),Angle(90,180,-90),"ValveBiped.Bip01_R_Hand",Vector(1,1,1),"")
    end
end
