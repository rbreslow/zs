...
if CLIENT then
    ...
    function SWEP:DrawWorldModel()
        ...
        if not IsValid(owner) then
            ...
            self:AddWM(owner,"models/props_mining/pickaxe01.mdl",Vector(1.2,10,3.5),Angle(0,180,180),false,Vector(0.75,0.75,0.75),"")
        end
    end
    ...
    function SWEP:PostDrawViewModel(vm,ply,wep)
        ...
        self:AddVM(vm,"models/props_mining/pickaxe01.mdl",Vector(1.4,10,2.5),Angle(0,180,180),"ValveBiped.Bip01_R_Hand",Vector(0.75,0.75,0.75),"")
    end
end
