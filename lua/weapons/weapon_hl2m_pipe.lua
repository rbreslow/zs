...
if CLIENT then
    ...
    function SWEP:DrawWorldModel()
        ...
        if not IsValid(owner) then
            ...
            self:AddWM(owner,"models/props_canal/mattpipe.mdl",Vector(1.5,-5,3.5),Angle(0,-90,0),false,Vector(1,1,1),"")
        end
    end
    ...
    function SWEP:PostDrawViewModel(vm,ply,wep)
        ...
        self:AddVM(vm,"models/props_canal/mattpipe.mdl",Vector(1.2,-5,2.5),Angle(0,0,0),"ValveBiped.Bip01_R_Hand",Vector(1,1,1),"")
    end
end
